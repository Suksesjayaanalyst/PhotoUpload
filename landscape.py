...
if start2:
    ...
    with st.spinner("Waiting..."):
        ...
        selected_df = pd.merge(selected_df, file_catalogue[['Item No.', 'Item Description','Uom','IsiCtn', 'Kategori', 'Harga Under', 'HargaLusin', 'HargaKoli', 'HargaSpecial']], left_on='ItemCode', right_on='Item No.', how='left')
