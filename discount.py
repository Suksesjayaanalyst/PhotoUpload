...
if start2:
    ...
    with st.spinner("Making Image..."):
        ...
        def add_text(template, draw, row, font):
            ...
            harga_jual_baru = f"Rp. {hargabaru:,} / {row['Uom']}"
            ...
            lines_harga_jual_lama = wrap_text(harga_jual_lama, font, max_width=450)
            lines_harga_jual_baru = wrap_text(harga_jual_baru, font, max_width=450)
            ...
            for line in all_lines:
                if line in lines_item_code:
                    ...
                    font = current_font
                elif line in lines_harga_jual_baru:
                    font = font_harga
                ...
                if line in lines_harga_jual_lama:
                    line_y_position = y_offset + text_height // 2  # Posisi tengah vertikal teks
                    draw.line([text_x, line_y_position, text_x + text_width, line_y_position], fill="red", width=2)
    ...
    with st.spinner("Paste to template..."):
        ...
        for index, row in selected_df.iterrows():
            ...
            add_text(img_template, draw, row, font)
